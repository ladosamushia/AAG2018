...
effects in DESI and slitless-spectroscopy effects in Euclid \cite{}. Two
...
generalise pair-wise weighting schemes to triplet-wise weighting. In fact, the
bit-wise weights as implemented in Ref.~[] can be very easily translated into
triplet-wise weights.
...
non-standard models. He is currently partially funded (one month of summer
support) by DOE to work on observational implications of non-flat models.
